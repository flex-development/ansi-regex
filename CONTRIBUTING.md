...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/ansi-regex
   cd ansi-regex
   ```
...
```sh
https://github.com/flex-development/ansi-regex/compare/main...$branch
```
...
[qa]: https://github.com/flex-development/ansi-regex/discussions/new?category=q-a
